...
//        gameLookUp.setCheapestPriceEver(cheapestPriceEver);
//
...
//        deals.add(deal2);
//
//        gameLookUp.setDeals(deals);
//
//
//        when(mockJsonMapper.mapToGameDealResponse(json)).thenReturn(gameLookUp);
//
//        GameLookUp result = mockJsonMapper.mapToGameDealResponse(json);
//
...
//        String json = "[]";
//
//        GameLookUp expectedResult = new GameLookUp();
